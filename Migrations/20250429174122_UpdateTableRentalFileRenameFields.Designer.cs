...
namespace LodgerBackend.Migrations
{
    ...
    [Migration("20250429174122_UpdateTableRentalFileRenameFields")]
    partial class UpdateTableRentalFileRenameFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LodgerBackend.App.Document.Models.Document", b =>
                {
                    ...
                    b.Property<int>("DocumentCategorieId")
                        .HasColumnType("integer")
                        .HasColumnName("document_categorie_id");
            ...
            modelBuilder.Entity("LodgerBackend.App.RentalFile.Models.RentalFile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("LodgerBackend.App.User.Models.Entities.Comment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("LodgerBackend.App.User.Models.Entities.User", b =>
                {
                    ...
                    b.HasOne("LodgerBackend.App.RentalFile.Models.RentalFile", "RentalFile")
                        .WithOne("User")
                        .HasForeignKey("LodgerBackend.App.User.Models.Entities.User", "RentalFileId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
