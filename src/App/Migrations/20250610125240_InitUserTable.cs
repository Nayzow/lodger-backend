        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    acces_token_expiration = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    status_pro = table.Column<int>(type: "integer", nullable: false),
                    net_monthly_income = table.Column<decimal>(type: "numeric", nullable: false),
                    guarantor = table.Column<int>(type: "integer", nullable: false),
                    net_monthly_income_garant = table.Column<decimal>(type: "numeric", nullable: false),
                    family_status = table.Column<int>(type: "integer", nullable: false),
                    roomates_nb = table.Column<int>(type: "integer", nullable: false),
                    pets = table.Column<bool>(type: "boolean", nullable: false),
                    smoker = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_rental_files", x => x.id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    user_id = table.Column<int>(type: "integer", nullable: false),
                    Token = table.Column<string>(type: "character varying(10000)", maxLength: 10000, nullable: true),
                    RequestedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    ExpiresAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_reset_password_request", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    rental_file_id = table.Column<int>(type: "integer", nullable: false),
                    ...
                    is2fa = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    document_categorie_id = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
